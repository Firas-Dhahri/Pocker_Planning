...
import {WebsocketserviceService} from "../sessionservice/websocketservice.service";
...
export class AuthService {
  constructor(private http: HttpClient, private storageService: StorageService , private websocketservice:WebsocketserviceService) {}

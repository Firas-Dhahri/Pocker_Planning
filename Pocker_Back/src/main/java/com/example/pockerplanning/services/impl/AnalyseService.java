...
public class AnalyseService implements IAnalyseService {
    ...
    @Override
    public List<Sprint> sprint_en_cours(int id) {
        List<Sprint> allSprints = sprintRepository.getprojet_par_sprint(id);
    ...
    @Override
    public ResponseEntity<Map<Long, Date>> getprojetpartime(int id_projet) {
    ...
    @Override
    public Float Pourcentage_avancemenet_pojet(int id_projet) {
        float pourcentage;
        Projet p = projetReposiroty.findById(id_projet).orElse(null);
